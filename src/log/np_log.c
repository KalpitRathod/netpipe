...
void np_log_set_level(np_log_level_t level) { g_log.level = level; }
void np_log_set_color(bool enable)           { g_log.color = enable; }
void np_log_set_file(FILE *fp)               { g_log.fp    = fp ? fp : stderr; }
np_log_level_t np_log_get_level(void)        { return g_log.level; }
